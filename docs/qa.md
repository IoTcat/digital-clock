...
请务必保证译码器的 A,B,C,D脚(参考：[译码器连法](/instro#译码器连法),[译码器电路示意图](https://digitalclock.eee.dog/#/attach?id=译码器电路示意图), [数字屏电路示意图](https://digitalclock.eee.dog/#/attach?id=数字屏电路示意图))正确地连接到代码中你自定义的pin脚(默认为9,10,11,12和5,6,7,8)<br/>
